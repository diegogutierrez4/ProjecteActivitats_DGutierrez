...
namespace ProjecteActivitatsWPF_DGutierrez.Accés_a_dades
{
    class ActivitatsBD
    {
        ...
        public void AfegirActivitat(string nom, string ubicacio, string categoria, string descripcio, string durada, decimal preu, int usuariCreador, string nomImatge)
        {
            try
            {
                string registrarActivitat = $"INSERT INTO activitats (nom, ubicacio, categoria, descripcio, durada, preu, usuariCreador, linkImatge) VALUES ('{nom}', '{ubicacio}', '{categoria}', '{descripcio}', '{durada}', '{preu}', {usuariCreador}, {nomImatge})";
